...
export default (props) => {
	...
	// Cambiamos entre styles y styles2 según isDarkMode
		...
		<SafeAreaView style={currentStyles.container}>
			<ScrollView style={currentStyles.scrollView}>
				<View style={currentStyles.row2}>
					<Image
						source={require('../../assets/images/CONFIG/perfil.png')}
						resizeMode={"stretch"}
				...
				<View style={currentStyles.row3}>
					<Image
						source={require('../../assets/images/CONFIG/param.png')}
						resizeMode={"stretch"}
				...
				<View style={currentStyles.row4}>
					<Image
						source={require('../../assets/images/CONFIG/home.png')}
						resizeMode={"stretch"}
						style={currentStyles.image4}
					/>
					<Image
						source={require('../../assets/images/CONFIG/analis.png')}
						resizeMode={"stretch"}
						style={currentStyles.image5}
					/>
					<Image
						source={require('../../assets/images/CONFIG/inv.png')}
						resizeMode={"stretch"}
						style={currentStyles.image6}
					/>
					<Image
						source={require('../../assets/images/CONFIG/conf.png')}
						resizeMode={"stretch"}
						style={currentStyles.image7}
					/>
					<Image
						source={require('../../assets/images/CONFIG/usrr.png')}
						resizeMode={"stretch"}
